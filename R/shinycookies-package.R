# Everything here ideally should be exported from a shinycookies package, but I
# don't want to take that side quest yet. Note that this new package will
# replace httpuv in Imports.
